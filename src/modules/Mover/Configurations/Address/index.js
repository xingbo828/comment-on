...
import { localSaveAddresses, loadAddresses, resetAddresses } from '../configurationActions';

import { getAddresses } from '../configurationReducers';
...
const enhance = compose(
  ...
  reduxForm({
    form: 'mover.configurations.address',
    validate,
