...
const AvatarWithImgAndSize = withInfo('Avatar with image src and size')(() => (
  <Avatar size="lg" src={avatarSrc} />
));

const AvatarWithIcon = withInfo('Avatar with icon')(() => (
  <Avatar
...
const AvatarWithIconAndSize = withInfo('Avatar with icon and size')(() => (
  <Avatar
    style={{ backgroundColor: '#87d068', color: 'white' }}
    size="lg"
    iconSize="2x"
